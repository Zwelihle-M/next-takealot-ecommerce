...
const ShoppingBasket = () => {
  ...
  return (
    <div className="fixed bottom-10 right-10 z-10 flex h-16 w-16 cursor-pointer items-center justify-center rounded-full bg-gradient-to-r from-sky-400 to-blue-500">
      {cartItemsCount > 0 && (
